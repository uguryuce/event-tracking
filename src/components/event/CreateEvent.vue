        ...
        <div class="create-event-form-item create-event-form-datepicker">
          <div class="location-form">
            ...
            <div class="location-form-city">
              <label>Lokasyon İl</label>
              <select style="color: #9fa4af;" class="location-form-city-select" v-model="event.selectedCity" >
            ...
            <div class="location-form-district">
              <label>Lokasyon İlçe</label>
              <select style="color: #9fa4af;" required class="location-form-district-select" v-model="event.selectedDistrict" >

                <option style="color: #9fa4af;" disabled selected>Seçiniz</option>

                <option style="color: #9fa4af;" v-for="ilceler in ilce" v-if="event.selectedCity === ilceler.il" >
                  {{ilceler.ilce}}
                </option>
...
<script>
  ...
  import LocationForm from "../event/LocationForm";
